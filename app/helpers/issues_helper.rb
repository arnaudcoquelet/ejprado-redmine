...
module IssuesHelper
  ...
  def show_detail(detail, no_html=false)
    ...
    when 'attr'
	  ...
	  when 'client_buyer_name','client_buyer_firstname','client_buyer_idnumber'
  ...
  def issues_to_csv(issues, project = nil)
    ...
    CSV::Writer.generate(export, l(:general_csv_separator)) do |csv|
      ...
      headers = [ "#", 
                  l(:field_project),
                  l(:field_tracker),
				          l(:field_client_buyer_name),
				          l(:field_client_buyer_firstname),
				          l(:field_client_buyer_idnumber),
                  l(:field_subject),
                  l(:field_status),
                  l(:field_start_date),
                  l(:field_due_date),
      ...
      issues.each do |issue|
        fields = [issue.id, 
                  issue.project.name,
                  issue.tracker.name, 
				          issue.client_buyer_name,
				          issue.client_buyer_firstname,
				          issue.client_buyer_idnumber,
                  issue.subject,
                  issue.status.name,
