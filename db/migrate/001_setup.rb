...
class Setup < ActiveRecord::Migration
  ...
  def self.up
    ...
    create_table "issue_statuses", :force => true do |t|
      t.column "name", :string, :limit => 30, :default => "", :null => false
	  t.column "duration", :integer, :default => "", :null => false
	  t.column "progress", :integer, :default => "", :null => false
    ...
    create_table "issues", :force => true do |t|
      t.column "tracker_id", :integer, :default => 0, :null => false
      t.column "project_id", :integer, :default => 0, :null => false
	    t.column "client_buyer_name", :string, :default => "", :null => false
	    t.column "client_buyer_firstname", :string, :default => "", :null => false
	    t.column "client_buyer_idnumber", :string, :default => "", :null => false
			    t.column "client_seller_name", :string, :default => "", :null => false
	    t.column "client_seller_firstname", :string, :default => "", :null => false
	    t.column "client_seller_idnumber", :string, :default => "", :null => false
      t.column "subject", :string, :default => "", :null => false
      t.column "description", :text
      t.column "due_date", :date
      t.column "duestep_date", :date
      t.column "progess_status", :integer
