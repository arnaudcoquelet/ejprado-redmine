...
Redmine::AccessControl.map do |map|
  ...
  map.project_module :issue_tracking do |map|
    ...
    map.permission :view_private_information, {:issues => [:index, :changes, :show, :context_menu]}
    map.permission :view_history, {:issues => [:index, :changes, :show, :context_menu]}
	map.permission :view_customer_infos, {:issues => [:index, :changes, :show, :context_menu]}
	map.permission :edit_customer_infos, {:issues => [:index, :changes, :show, :context_menu]}
	
	map.permission :view_internal_infos, {:issues => [:index, :changes, :show, :context_menu]}
	map.permission :edit_internal_infos, {:issues => [:index, :changes, :show, :context_menu]}
	
	map.permission :edit_private_information, {:issues => [:edit, :reply, :bulk_edit, :destroy_attachment]}
  ...
  map.project_module :time_tracking do |map|
    ...
    map.project_module :accounting do |map|
    map.permission :view_accounting, :accounting => [:details, :report]
    map.permission :edit_accounting, {:accounting => [:edit, :destroy]}, :require => :member
  end
  
  map.project_module :cost_tracking do |map|
    map.permission :log_cost, {:costlog => :edit}, :require => :loggedin
    map.permission :view_cost_entries, :costlog => [:details, :report]
    map.permission :edit_cost_entries, {:costlog => [:edit, :destroy]}, :require => :member
    map.permission :edit_own_cost_entries, {:costlog => [:edit, :destroy]}, :require => :loggedin
  end
